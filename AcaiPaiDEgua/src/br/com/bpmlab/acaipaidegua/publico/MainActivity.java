...
public class MainActivity extends Activity implements LocationListener {
	...
	public void onBackPressed() {
	  if (this.lastBackPressTime < System.currentTimeMillis() - 4000) {
	    toast = Toast.makeText(this, "Pressione o bot�o voltar novamente para fechar o aplicativo.", 4000);
	    toast.show();
	...
	public void chamaAlertNovaVersao() {
		...
		alerta.setTitle("Já sabe da novidade?");
		alerta.setMessage("Estamos com um novo Açaí Paidégua. É só clicar aqui para baixar a versão mais nova. Esta versão será descontinuada em breve.");
